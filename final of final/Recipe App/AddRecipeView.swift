...
//  Recipe App
//
//  Created by Yuksing Li on 28/11/2024.
//
...
struct AddRecipeView: View {
    ...
    private func saveRecipe() {
        print("==============")
        print("recipe id: \(newRecipe.id)")
        print("findspace: \(RecipeViewModel().findSpace())")
        print("==============")
        ...
        saveImageToDocuments(image: image!, newid: newRecipe.id-1)
        //print(imagepath)
